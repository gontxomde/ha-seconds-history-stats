...
class HistoryStatsSecondSensor(SensorEntity):
    ...
    def native_value(self):
        ...
        if self._type == CONF_TYPE_RATIO:
            return HistoryStatsSecondHelper.pretty_ratio(self.value, self._period)
    ...
    def update_period(self):
        ...
        if self._start is not None:
            try:
                ...
                HistoryStatsSecondHelper.handle_template_exception(ex, "start")
                return
        ...
        if self._end is not None:
            try:
                ...
                HistoryStatsSecondHelper.handle_template_exception(ex, "end")
                return
